...
/*
function set_random_user(){
	$.ajax({
		  url: 'https://randomuser.me/api/',
		  dataType: 'json',
		  success: function(datsssa) {
		    console.log(datsssa.results[0]);

			$.ajax({
				  url: 'http://as-admin.com/welcome/ajax',
				  type: "POST",
				  data: {
				  	mydata : datsssa.results[0],
				  },
...
$(document).ready(function(){
	...
	$("input.as_custom_focus").focus(function() {
		
		$(this).parent(".input-prepend").addClass("input-prepend-focus");
	
	});
	
	$("input.as_custom_focus").focusout(function() {
